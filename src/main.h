...
public:
    ...
    {
        // Circulatecoin: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Circulatecoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Circulatecoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Circulatecoin: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Circulatecoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Circulatecoin: block index flags
    enum  
    {
