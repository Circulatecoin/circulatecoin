...
const QString BITCOIN_IPC_PREFIX("Circulatecoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Circulatecoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Circulatecoin: click-to-pay handler");
    else
...
{
    // clicking on Circulatecoin: URLs creates FileOpen events on the Mac:
